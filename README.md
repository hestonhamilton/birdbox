...
## Setup Steps
1. Install a compatible OS on the boot drive. Official documentation on enabling Raspberry Pi USB boot can be found [here](https://www.raspberrypi.com/documentation/computers/raspberry-pi.html#usb-mass-storage-boot).
